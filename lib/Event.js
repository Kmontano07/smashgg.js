...
class Event extends EventEmitter{
    ...
    constructor(tournamentName, eventName, expands, isCached, id=null){
        super();
        ...
        */
        ...
        if(!id){
            ...
            T.on('ready', function(){
                ...
                ThisEvent.load()
                    .then(function(){
                        let cacheKey = format(EVENT_TOURNAMENT_CACHE_KEY, ThisEvent.tournamentName, ThisEvent.eventName, ThisEvent.expandsString);
